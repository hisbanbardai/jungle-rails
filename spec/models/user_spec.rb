...
RSpec.describe User, type: :model do
  ...
  describe '.authenticate_with_credentials' do
    ...
    it 'does not authenticate a user when provided email does not exist in the database' do
      @user = User.new(
      name: 'Hisban',
      email: 'test@test.com',
      password: '123456',
    ...
    @user.save
    expect(@user).to be_valid
    expect(@user.authenticate_with_credentials('test1@test.com', '123456')).to be nil
    end

    it 'does not authenticate a user when provided password is incorrect' do
      @user = User.new(
      name: 'Hisban',
      email: 'test@test.com',
      password: '123456',
